          ...
          <div class="box mb-20 box-primary">
            ...
            <div v-if="!hasSupport" class="external support-links mt-20">
              <div class="support-link">
                <a class="support-link" href="https://bigopen.io/support" target="_blank" rel="noopener noreferrer nofollow">{{ t('support.community.learnMore') }}</a>
              </div>
              <div class="support-link">
                <a class="support-link" href="https://bigopen.io/pricing" target="_blank" rel="noopener noreferrer nofollow">{{ t('support.community.pricing') }}</a>
              </div>
            </div>
            <div v-else>
              <p class="pb-10">
